 ...
 * @package pk_layout
*/ 
class rdLayoutTreeCol extends rdLayout
{
                           ...
                           $p_footer)
  {
    ...
    $this->divSideTwo = clsrdFactoryClass::createObject("tagcomponent.clsTagDiv");		
    $this->addSection($p_sidetwo,$this->divSideTwo); 
    ...
    $this->divContainer->add_Element($this->divSideTwo);        
